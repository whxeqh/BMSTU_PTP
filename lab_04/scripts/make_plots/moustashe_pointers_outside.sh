...
set output '../../plots/moustashe_pointers_outside.svg'

set xlabel "Количество элементов, шт"
set ylabel "Время, мкс"
set grid
set title "График с усами для измерений времени снаружи. Указатели"

plot "../../prepdata/index_inside/data.txt" using 1:3:2:6:5 with candlesticks notitle whiskerbars,\
     "../../prepdata/index_inside/data.txt" using 1:7 with linespoints title "pointers outside", \
